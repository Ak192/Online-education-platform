...
if($requestname=="/ecommerce/about.php"){
    $menuArr['about']="active";
}
       ...
       <!-- <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="index.php" class="nav-item nav-link <?php echo $menuArr['home'];?>">Home</a>
            ...
            if(isset($_SESSION['user_id'])){
                ?>
                 <a href="profile.php" class="nav-item nav-link <?php //echo $menuArr['home'];?>">My Account</a>
                <?php
            }
             ?>
            </div>
            ...
            <?php 
            if(isset($_SESSION['user_id'])){
              echo'<a href="logout.php" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Logout now <i class="fa fa-arrow-right ms-3"></i></a>';
            }
            else{
                echo'<a href="login.php" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Login now <i class="fa fa-arrow-right ms-3"></i></a>';
            }
