                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="adminpanel/CourseImage/<?php echo $image; ?>" alt="Image">
                        </div>
                ...
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                       <!-- <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <a href="checkout.php?id=<?php echo $id; ?>"><button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Buy Now</button></a>
                    </div>
                    ...
                    <div class="tab-content">
                       ...
                       <!-- <div class="tab-pane fade" id="tab-pane-2">
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="mb-4">1 review for "<?php echo $title;?>"</h4>
                                    <div class="media mb-4">
                                        <img src="adminpanel/CourseImage/<?php echo $image; ?>" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6><?php echo $faculty;?><small> - <i><?php echo $start_date ; ?></i></small></h6>
